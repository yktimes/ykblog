  ...
  <div class="media g-mb-20">
    ...
    <div class="media-body g-brd-around g-brd-gray-light-v4 g-pa-20">
      <div class="d-sm-flex justify-content-sm-between align-items-sm-center g-mb-15 g-mb-10--sm">
        <h5 v-if="comment.author.id == comment.post.author" class="h4 g-font-weight-300 g-mr-10 g-mb-5 g-mb-0--sm g-color-pink">{{ comment.author.name || comment.author.username }} <span class="h6">(作者)</span></h5>
