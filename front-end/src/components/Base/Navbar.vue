                ...
                <router-link to="/login"> 登录</router-link>
                   ...
                   <router-link to="/register"> 注册</router-link>
								...
								<el-submenu v-if="sharedState.is_authenticated" index="3">
									...
									<el-menu-item >
                 <router-link v-bind:to="{ path: `/user/${sharedState.user_id}` }">我的主页</router-link>


                  </el-menu-item>
									<el-menu-item >
                     <router-link v-bind:to="{ name: 'PostsResource' } ">我的资源</router-link>
                  </el-menu-item>
									<el-menu-item >
                <router-link v-bind:to="{ name: 'SettingProfile' } ">设置</router-link>

                  </el-menu-item>
									<el-menu-item >
               <a v-on:click="handlerLogout" href="#">退出</a>
