  ...
  <nav aria-label="Page Navigation" class="g-mb-50">
    <ul class="list-inline">
      <li class="list-inline-item">
        <router-link v-bind:to="{ path: '$route.path'+'api/posts/', query: {page: curPage - 1, per_page: perPage }}" v-bind:class="{'u-pagination-v1__item--disabled': curPage == 1}" class="u-pagination-v1__item u-pagination-v1-1 g-rounded-50 g-pa-12-21" aria-label="Previous">
      ...
      <li v-if="page != 'NaN'" v-for="(page, index) in iter_pages" v-bind:key="index" class="list-inline-item g-hidden-sm-down">
        <router-link v-bind:to="{ path: $route.path+'api/posts/', query: {page: page, per_page: perPage }}" v-bind:class="{'u-pagination-v1-1--active': $route.query.page == page || (!$route.query.page && page == 1)}" class="u-pagination-v1__item u-pagination-v1-1 g-rounded-50 g-pa-12-19">{{ page }}</router-link>
      </li>
      ...
      <li class="list-inline-item">
        <router-link v-bind:to="{ path: $route.path+'api/posts/', query: {page: curPage + 1, per_page: perPage }}" v-bind:class="{'u-pagination-v1__item--disabled': curPage == totalPages || totalPages == 0 }" class="u-pagination-v1__item u-pagination-v1-1 g-rounded-50 g-pa-12-21" aria-label="Next">
          <span aria-hidden="true">
