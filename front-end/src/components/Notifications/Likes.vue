    ...
    <div class="card border-0 g-mb-15">
      ...
      <div v-if="likes" class="card-block g-pa-0" >
        ...
        <div class="media g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-20"
          v-for="(like, index) in like_list" v-bind:key="index">
          <router-link v-bind:to="{ path: `/user/${like.user.id}` }">
            <span v-if="like.is_new" class="d-inline-block g-pos-rel">
              ...
              <img class="d-flex g-width-50 g-height-50 rounded-circle g-mt-3 g-mr-15" v-bind:src="like.user.avatar" v-bind:alt="like.user.name || like.user.username">
            </span>
            <img v-else class="d-flex g-width-50 g-height-50 rounded-circle g-mt-3 g-mr-15" v-bind:src="like.user.avatar" v-bind:alt="like.user.name || like.user.username">
          </router-link>
            ...
            <ul class="list-inline d-sm-flex my-0">
              <li v-if="!like.comment.disabled" class="list-inline-item g-mr-20">
                <span class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover">
                  <i v-bind:class="{ 'g-color-red': like.comment.liked.indexOf(sharedState.user_id) != -1 }" class="icon-like g-pos-rel g-top-1 g-mr-3"></i>
